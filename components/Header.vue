<template>
  <div>
    ...
    <div class="bg-white pb-6 sm:pb-8 lg:pb-12">
      ...
      <section class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div class="flex flex-wrap justify-between mb-8 md:mb-16">
          ...
          >
            <h1
              class="text-black-800 text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-8"
            >
        ...
        >
          <div
            class="w-64 h-12 flex border rounded-lg overflow-hidden divide-x"
          >
            <a
              href="#"
          ...
          <div>
            ...
            >
              ...
              <div class="flex gap-2 absolute left-0 bottom-2">
                ...
                >
                <span
                  class="bg-white text-gray-800 text-sm font-bold tracking-wider uppercase rounded-lg px-3 py-1.5"
                  >New</span
                >
              </div>
            </a>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
      <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div
          class="md:h-80 flex flex-col sm:flex-row bg-gray-900 rounded-lg overflow-hidden"
        >
          <!-- content - start -->
          <div class="w-full sm:w-1/2 lg:w-2/5 flex flex-col p-4 sm:p-8">
            <h2
              class="text-white text-xl md:text-2xl lg:text-4xl font-bold mb-4"
            >
          ...
          <!-- image - start -->
          <div
            class="w-full sm:w-1/2 lg:w-3/5 h-48 sm:h-auto order-first sm:order-none bg-gray-700"
          >
            <img
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
      <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div
          class="flex flex-col lg:flex-row lg:justify-between items-center bg-gray-100 rounded-lg p-4 sm:p-8"
        >
          <div class="mb-4 sm:mb-8 lg:mb-0">
            <h2
              class="text-indigo-500 text-xl sm:text-2xl lg:text-3xl font-bold text-center lg:text-left"
            >
          ...
          <div class="flex flex-col items-center lg:items-end">
            ...
            <p class="text-gray-400 text-xs text-center lg:text-right">
    ...
    <div class="bg-white pt-4 sm:pt-10 lg:pt-12">
      <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div
          class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16"
        >
